...
exports.CoreHttpLro = exports.getSpecPath = exports.shouldDeserializeLro = exports.createPollingMethod = exports.terminalStates = exports.failureStates = exports.successStates = void 0;
...
function createPollingMethod(sendOperationFn, getLroStatusFromResponse, args, spec, mode) {
    ...
    if (mode === "AzureAsync") {
        return (path) => __awaiter(this, void 0, void 0, function* () {
            const { flatResponse, rawResponse } = yield sendOperationFn(args, Object.assign(Object.assign(Object.assign({}, restSpec), { responses: getCompositeMappers(responses), httpMethod: "GET" }), (path && { path })));
            return getLroStatusFromResponse(rawResponse, flatResponse);
        });
    }
    return (path) => __awaiter(this, void 0, void 0, function* () {
        const { flatResponse, rawResponse } = yield sendOperationFn(args, Object.assign(Object.assign(Object.assign({}, restSpec), { responses: responses, httpMethod: "GET" }), (path && { path })));
        return getLroStatusFromResponse(rawResponse, flatResponse);
    });
}
...
class CoreHttpLro {
    ...
    sendInitialRequest(initializeState) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield this.sendOperationFn(this.args, this.spec);
...
exports.CoreHttpLro = CoreHttpLro;
//# sourceMappingURL=coreHttpLro.js.map